...
export default function SearchLocationBar() {
  ...
  <div className="flex items-center gap-2">
    {/* Search Bar */}
    <div
      className="relative flex w-full bg-background/60 backdrop-blur border rounded-xl shadow-sm"
      ref={searchRef}
    >
      <div className="flex-1 relative">
        ...
        <Input
          ...
          className="pl-11 h-11 border-none rounded-l-xl focus-visible:ring-0"
        />
      </div>

      {/* Search Results */}
      {showSearchResults && (
        <div className="absolute top-full mt-3 w-[26rem] bg-background border rounded-xl shadow-xl z-50 max-h-[420px] overflow-y-auto">
          {searchLoading ? (
            ...
            <div className="py-2">
              ...
              {searchResults.map((event) => (
                <button
                  ...
                  className="w-full px-4 py-3 hover:bg-muted/60 text-left transition-colors"
                >
