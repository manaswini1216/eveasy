...
import { CATEGORIES, getCategoryStyle } from "@/lib/data";
...
export default function ExplorePage() {
  ...
  return (
    <div className="relative">
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-blue-950/30 via-background to-background" />
      ...
      <div className="relative">
        ...
        <div className="pb-12 text-center">
          ...
          <p className="text-lg text-blue-200/80 max-w-3xl mx-auto">
                Discover exciting events, meet new people, and explore what’s happening nearby or across India
